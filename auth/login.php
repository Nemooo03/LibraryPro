...
if (isLoggedIn()) {
    header('Location: ' . BASE_URL . ($_SESSION['role'] === 'borrower' ? '/user/index.php' : '/admin/index.php'));
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$email || !$password) {
        ...
        if ($user) {
            ...
            header('Location: ' . BASE_URL . ($user['role'] === 'borrower' ? '/user/index.php' : '/admin/index.php'));
            exit;
        } else {
